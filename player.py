...
class Player(Game, pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.left_side_image = pygame.transform.scale(pygame.image.load(os.path.join("images", "character_left_image(original).png")).convert_alpha(), (100, 100))
        self.right_side_image = pygame.transform.scale(pygame.image.load(os.path.join("images", "character_right_image(original).png")).convert_alpha(), (100, 100))
